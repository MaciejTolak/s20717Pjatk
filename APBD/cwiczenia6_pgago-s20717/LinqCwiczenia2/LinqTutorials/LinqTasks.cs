...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = Depts.Join(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, emp) => new { emp.Ename, emp.Job, dept.Dname });
        ...
        public static IEnumerable<object> Task10()
        {
           ...
           listTMP.Add(tmp);
            ...
            result = Emps.Select(e => new { e.Ename, e.Job, e.HireDate }).Union(listTMP);
            return result;
        }
        ...
        {
            IEnumerable<object> result = Depts.Join(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, emp) => new { dept, emp })
                                                                        .GroupBy(e => e.dept.Dname).Where(e => e.Count() > 1).Select(e => new { name = e.Key, numOfEmployees  = e.Count()});
            return result;
        }
        ...
        {
          IEnumerable<Dept> result = Depts.GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, emp) => new { dept, emp })
                                                            .Where(e => !e.emp.Any() || e.emp.Count() == 5)
                                                            .Select(e => e.dept); 
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> GetEmpsWithSubordinates(this IEnumerable<Emp> emps)
        {
            ...
            return emps.Where(e => e.Mgr != null).OrderBy(e => e.Ename).ThenByDescending(e => e.Salary);
        }
